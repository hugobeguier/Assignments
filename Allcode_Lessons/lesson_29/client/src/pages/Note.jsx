...
export default function Note() {
    ...
    const resetForm = () => setNote(initialNote);
                            ...
                            <section className="rounded-xl border p-4">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="min-w-0">
                                        <div className="truncate text-sm font-medium text-gray-900">Jane Doe</div>
                                        <div className="truncate text-xs text-gray-500">jane@company.com</div>
                                    </div>
                                </div>
                            </section>
